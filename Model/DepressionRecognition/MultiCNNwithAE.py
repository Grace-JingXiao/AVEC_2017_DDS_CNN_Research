...
from Auxiliary.Shuffle import Shuff_Fivefold


class MultiCNNWithAE(NeuralNetwork_Base):
    def __init__(self, trainData, trainSeq, trainLabel, sentenceData, interviewData, firstAttention, firstAttentionName,
                 firstAttentionScope, secondAttention, secondAttentionName, secondAttentionScope, sentenceFlag=True,
                 interviewFlag=True, convSize=2, rnnLayers=1, hiddenNodules=128, batchSize=32, learningRate=1E-3,
        ...
        super(MultiCNNWithAE, self).__init__(
    ...
    def Train(self, logName):
        trainData, trainLabel, trainSeq, trainSentence, trainInterview = \
            Shuff_Fivefold(self.data, self.label, self.dataSeq, self.sentenceData, self.interviewData)
