...
from Model.DepressionRecognition.MultiCNN_NewTransform import MultiCNNWithSR_NewTransform
...
if __name__ == '__main__':
    ...
    classifier = MultiCNNWithSR_NewTransform(
    ...
    savepath = 'D:/PythonProjects_Data/Exp/NewTransform-Multi-CRNN-%s-%s-%s' % (
