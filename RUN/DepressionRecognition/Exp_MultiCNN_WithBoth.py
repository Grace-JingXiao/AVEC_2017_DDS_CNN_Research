...
from Model.DepressionRecognition.MultiCNNwithBoth import MultiCNNWithAESR
...
if __name__ == '__main__':
    ...
    classifier = MultiCNNWithAESR(
        trainData=trainData, trainSeq=trainSeq, trainLabel=trainLabel, sentenceData=trainDataSentence,
        interviewData=trainDataInterview, transformWeight=weight, convSize=convSize, firstAttention=firstAttention,
    ...
    savepath = 'D:/PythonProjects_Data/Exp-DR-with-AESR/Multi-CRNN-%s-%s-%s-%d' % (
